...
" CAPL specific
syn keyword	cType		byte word dword qword
syn keyword	cStorageClass	stack testcase testfunction includes variables
syn keyword     cStatement      on signal signal_change signal_update sysvar sysvar_change sysvar_update
